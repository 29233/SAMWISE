...
class CLAP_Module(torch.nn.Module):
    def __init__(self, enable_fusion=False, device=None, amodel= 'HTSAT-tiny', tmodel='roberta') -> None:
        ...
        self.tokenize = RobertaTokenizer.from_pretrained('/18018998051/SAMWISE/pretrain/roberta')
...
# try to extract a specific audio file
...
if __name__ == "__main__":
    ...
    t2 = time.time()
    print('audio embedding shape:', audio_embed.shape)
